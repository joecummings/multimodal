...
from torchmultimodal.architectures.flava import (
    EMBEDDING_OPTIONS,
    FLAVAArchitecture,
    FLAVAOutput,
)
...
from torchmultimodal.modules.encoders.flava_text_encoder import flava_text_encoder
...
class FLAVAForPreTraining(nn.Module, PretrainedMixin):
    ...
    def __init__(
        self, model: FLAVAArchitecture, image_codebook: nn.Module, loss: nn.Module
    ):
        super().__init__()
        self.model = model
